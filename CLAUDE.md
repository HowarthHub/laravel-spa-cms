...
- This application uses Pest for testing. All tests must be written as Pest tests.
...
- To filter on a particular test name: `vendor/bin/sail artisan test --compact --filter='test name here'` (recommended after making a change to a related file).
