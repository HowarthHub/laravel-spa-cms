    ...
    <AdminLayout>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Edit User</h1>
                <span v-if="user.last_login_at" class="text-xs text-gray-400 dark:text-gray-500">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-end">
                            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                <input v-model="form.is_active" type="checkbox" class="rounded border-gray-300 dark:border-gray-600 text-cyan-600" />
                                Active
                            </label>
                        </div>
                    </div>
