...
watch(() => form.template, (newTemplate, oldTemplate) => {
    if (pageBuilderTemplates.includes(newTemplate) && !pageBuilderTemplates.includes(oldTemplate)) {
        form.content = [];
    } else if (!pageBuilderTemplates.includes(newTemplate) && pageBuilderTemplates.includes(oldTemplate)) {
        form.content = null;
    }
});
